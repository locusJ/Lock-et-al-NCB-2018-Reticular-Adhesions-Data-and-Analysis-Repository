...
# Import individual data files
FRAP.data <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig2S_T", col_names = TRUE)

STORM.Data <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig2V_W", col_names = TRUE)
...
#define panel_file_name
FRAP_Curve_File_Name <- "Panel 2S b5 FRAP recovery"
...
NNND.boxplot.filename <- "Panel 2V nearest neighbour boxplot"
...
Molecule.number.boxplot.filename <- "Panel 2W molecular number boxplot"
...
CytoD2h_vs_control <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig3C", col_names = TRUE)
CytoD2h_vs_control <- CytoD2h_vs_control[,1:3]

Adhesion.Assay.Data <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig3E", col_names = TRUE)
Adhesion.Assay.Data <- Adhesion.Assay.Data[,1:4]

Talin.KD.Data <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig3H_I", col_names = TRUE)
...
#define panel_file_name
Adhesion_Assay_panel_file_name <- "Panel 3E Adhesion Assay Boxplots"
...
TalinKD_Cell_Area_panel_file_name <- "Panel 3H TalinKD_vs_Cell_Area"
...
TalinKD_b5_Intensity_panel_file_name <- "Panel 3I TalinKD_vs_b5_Intensity"
...
# Import individual data files
Primary.siRNA.Screen.Data <-  read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig5B_C", col_names = TRUE)

Neo.LY.Drug.Treatment.Data <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig5D", col_names = TRUE)
...
siRNA_boxplot_summary_filename <- "Panel 5B siRNA boxplot summary"
...
siRNA_parcoord_summary_filename <- "Panel 5C siRNA parcoord summary"
...
PIP_drug_boxplot_summary_filename <- "Panel 5D PIP drug boxplot summary"
...
Proliferation <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig6A", col_names = TRUE)
Proliferation$Day <- as.factor(Proliferation$Day)


EDU_Incorporation_Percentage <-  read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig6B", col_names = TRUE)
...
proliferation_linechart_filename <- "Panel 6A proliferation linechart"
...
#define panel_file_name
EDU_boxplot_panel_file_name <- "Panel 6B EDU Incorporation Boxplots"
...
STORM.Data <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig7E_F", col_names = TRUE)
...
NNND_boxplot_filename <- "Panel 7E NNND boxplot"
...
Mol_Count_boxplot_filename <- "Panel 7F Molecule Count boxplot"
...
Residual_Angle_data <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig8A_B", col_names = TRUE)

Cell_Division_Defect_Quantification <- read_xlsx(paste(data_input_path, data_file, sep = "/"), sheet = "Fig8C", col_names = TRUE)
...
#define panel_file_name
boxplot_panel_file_name <- "Panel 8A Residual Angle Boxplots"
...
#define panel_file_name
density_panel_file_name <- "Panel 8B Residual Angle Density Plot"
...
CDD_boxplot_panel_file_name <- "Panel 8C Cell Division Defect Rate Boxplot"
...
Secondary_siRNA_Screen_boxplots_filename <- "Panel SF6A Secondary_siRNA_Screen_boxplot_summary"
